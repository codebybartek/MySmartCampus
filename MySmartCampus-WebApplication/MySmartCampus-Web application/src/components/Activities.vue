  ...
  <div class="container navbar-offset-top">
    ...
    <div class="row" v-bind:class="{hide: showSingleContent}">
      <div class="col-12 col-sm-6 activitiesCalendar">
       ...
       <div class="add_activity col-12 col-lg-6" v-if="is_professor">
       ...
       <section class="col-12 activities_show">
        ...
        <table class="table table-hover">
          ...
          <tr v-for="activitySelected in activitiesSelected">
              ...
              <td v-if="is_professor"><a class="more" v-on:click="showSingle(activitySelected)">more..</a></td>
              <td v-if="is_professor"><a v-on:click="deleteActivity(activitySelected.id)" class="delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
          </tr>
        </table>
...
export default {
  ...
  methods: {
    addActivity(isRecurrent) {
      ...
      if(!this.activity.activityDate===""){
        this.errors.push("Activity date is required");
        return;
      }
      if(!this.activity.class_room){
        this.errors.push("Activity classroom is required");
        return;
      }
