    ...
    <div class="row top" v-bind:class="{showTopMobile: showMenu}">
      ...
      <nav class="col-12 col-md-9 col-lg-7 col-xl-6 navbar" v-bind:class="{show: showMenu}" key="navbar">
        <ul>
          ...
          <li v-if="is_professor" key="2"><router-link to="/subjects">Subjects <i class="fa fa-university" aria-hidden="true"></i></router-link></li>
        ...
        <ul>
          ...
          <li class="user">
            ...
            <div class="profile_info">
              <span class="user_data"><img v-bind:src="user_photo" alt="user image">{{user_name}}</span>
...
export default {
  ...
  created () {
    ...
    this.user_photo = window.$cookies.get('user_photo');
