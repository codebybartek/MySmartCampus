      ...
      <div class="row">
        <section class="col-12 form_register">
          ...
          <form class="form-add align-center custom-padding">      
            ...
            <input v-model="user.tagId" type="text" placeholder="User tagId" id="tagid"/>
    ...
    methods: {
      ...
      adduser(){
        ...
        if(this.errors.length === 0){
          ...
          .catch(function(error){
            let alert = {content: "User with this email exist", alertClass: "danger"};
            this.$emit('setAlert', alert);
      ...
      validate(){
        ...
        if(this.user.password.length < 6){
            this.errors.push("Password must has more than 5 characters!");
          }
        if(this.user.role===0){
